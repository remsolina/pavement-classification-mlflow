...
LOCAL_DATA_PATH = "./data/pavement_images"  # Expected structure: ./data/pavement_images/class_name/image.jpg

# MLflow configuration - points to local MLflow server
MLFLOW_TRACKING_URI = "http://localhost:5000"

# Training parameters - keep same as original for comparable results
batch_size = 32
...
print("Classes found locally:", full_dataset_no_transform.classes)
...
with mlflow.start_run(run_name=run_name):
    ...
    mlflow.log_param("data_path", LOCAL_DATA_PATH)
